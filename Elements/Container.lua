...
function ZF:CreateUnitContainer(unitFrame, unit)
    ...
    unitFrame.ContainerBorder:SetBackdrop({ edgeFile = ZF.BACKDROP.edgeFile, edgeSize = math.max(ContainerDB.BorderThickness, 1), insets = ZF.BACKDROP.insets })
    unitFrame.ContainerBorder:SetBackdropColor(0, 0, 0, 0)
    unitFrame.ContainerBorder:SetBackdropBorderColor(ContainerDB.BorderColor[1], ContainerDB.BorderColor[2], ContainerDB.BorderColor[3], ContainerDB.BorderThickness > 0 and ContainerDB.BorderOpacity or 0)
